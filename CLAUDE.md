...
- `sample-forms/applications/` — 11 filled TTB F 5100.31 (04/2023) application PDFs, a different shape from the registry print view: legal-size, 5 pages (last 4 are static instructions), data as flat text on page 1 (AcroForm widgets hold only form furniture), label images affixed on page 1. Seven have individual label images with typed FRONT/BACK/NECK captions; four embed a single uncaptioned photo of physical bottles. 06_graniteharbor is the two-spellings trap: brand display says HARBOUR, form and back-label boilerplate say HARBOR.
